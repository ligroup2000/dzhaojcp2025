...
[p,b,t,nv,nbe,nt,labels]=ffreadmesh('Lshape_mesh.msh');
[vh]=ffreaddata('Lshape_vh.txt');
[apsi_t1]=ffreaddata('Lshape_apsi_t1.txt');[apsi_t5]=ffreaddata('Lshape_apsi_t5.txt');[apsi_t10]=ffreaddata('Lshape_apsi_t10.txt');
[apsi_t20]=ffreaddata('Lshape_apsi_t20.txt');[apsi_t40]=ffreaddata('Lshape_apsi_t40.txt');
[cA_t1]=ffreaddata('Lshape_cA_t1.txt');[cA_t5]=ffreaddata('Lshape_cA_t5.txt');[cA_t10]=ffreaddata('Lshape_cA_t10.txt');
[cA_t20]=ffreaddata('Lshape_cA_t20.txt');[cA_t40]=ffreaddata('Lshape_cA_t40.txt');

%%%%%% 2D Patch (density map) Plot of apsi and cA
figure;
ffpdeplot(p,b,t,'VhSeq',vh, 'XYData',apsi_t1,'ColorMap',jet(150),'Mesh','off', 'Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',apsi_t5,'ColorMap',jet(150), 'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',apsi_t10,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',apsi_t20,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',apsi_t40,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');

figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',cA_t1,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',cA_t5,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',cA_t10,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',cA_t20,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
figure;
ffpdeplot(p,b,t,'VhSeq',vh,'XYData',cA_t40,'ColorMap',jet(150),'Mesh','off','Boundary','off','XLim',[-0.5 0.5],'YLim',[-0.5 0.5]);
ylabel('y');xlabel('x');
